...
import { Store, Menu, ChevronDown, Clock } from "lucide-react";
import { db } from "../lib/frappe";
import { Sidebar } from "../la/Sidebar"; // ✅ Import Sidebar Component
import { ItemList } from "../ui/ItemList"; // ✅ Import ItemList Component
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <Sidebar
        ...
        onSelectCategory={setSelectedCategory} // ✅ Pass Function
      />
