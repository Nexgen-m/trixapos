...
import { Cart } from '../cart/Cart'; // ✅ Ensure the right sidebar (cart) is included
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <Sidebar
        ...
        onSelectCategory={setSelectedCategory} // ✅ Correct function implementation
      />
      ...
      <div className="flex-1 flex">
        ...
        {/* ✅ Right Sidebar (Cart) - Ensuring it remains in layout */}
        <div className="w-80 bg-gray-900 text-white p-4">
          <Cart /> {/* ✅ Ensure Cart remains */}
        </div>
      </div>
    </div>
  );
