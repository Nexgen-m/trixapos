  ...
  return (
    <Dialog open={isOpen} modal onOpenChange={() => {}}>
      <DialogContent
        ...
        className="w-full max-w-lg p-6 bg-white rounded-lg shadow-lg flex flex-col items-center"
      >
        <DialogHeader>
              ...
              {!status.includes("Cancelled") &&
                ...
                !status.includes("Completed") && (
                  <p className="text-gray-600 text-sm">
                    Inserted: €{(inserted / 100).toFixed(2)} / Needed: €
          ...
          {!status.includes("Cancelled") && (
            <div className="w-full bg-gray-200 rounded-full h-3 mt-2">
              <div
                ...
                style={{
                  width: `${status.includes("Checking") ? 100 : progress}%`,
                }}
              >
